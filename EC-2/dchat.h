...
}*headHoldBackList, *tailHoldBackList,*headFairQueue, *tailFairQueue;
...
typedef struct FairQList FairQList;

//Global Variables
ChatUserInfo chatUser[20];
FairQList fairQList[20];
char IP[20];
...
void resetAllSeqNum();
int numOfChatUsers();
void printList(QueueNode **, QueueNode **);
int isTableEmpty();
void closeChatServer();
void printUsers();
void resetAllTimers();
void printQ(QueueNode **, QueueNode **);
void fairQueue(char *,InsertionList**, InsertionList**);
int getIDForUser(char *);
int getMsgNumForUser(char *);
char *RemoveNodeFairQ(char *msgbuf, InsertionList**, InsertionList**);
void printInsertionList(InsertionList **, InsertionList **);
void insertFairQ(int ,char *);
void printFairQ();
char *removeFairQ(char *,int );
