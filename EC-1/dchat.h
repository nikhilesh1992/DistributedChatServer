...
typedef struct UsernameMap UsernameMap;
...
int numOfChatUsers();
int isTableEmpty();
void *threadForTrafficControl(void *);
void *threadForMapRefresh(void *);
void *threadForMsgCount(void *);
char *congestionCommandConstruct(char *,int );
void updateMap(char *);
void printMap();
void initialiseMap();
